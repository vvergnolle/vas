...
/**
 * Invoke the {@link HttpHandlerPostProcessor#postProcess(BootContext)} method when the default {@link PathHandler} is created
 * 
 */
public interface HttpHandlerPostProcessor {
	 ...
	 * {@link PathHandler#addPrefixPath(String, io.undertow.server.HttpHandler)} or {@link PathHandler#addExactPath(String, io.undertow.server.HttpHandler)}
	 * methods.
	 * 
	 * <br/><br/>
	 * 
	 * For more informations about Undertow and more precisely handlers, check the <a href="http://undertow.io/documentation/index.html">documentation</a>.
	 */
