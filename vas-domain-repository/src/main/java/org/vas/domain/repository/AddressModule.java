...
public class AddressModule extends AbstractModule implements GuiceModuleDescriptor {
    ...
    try {
    	ConnectionSource connectionSource = new JdbcConnectionSource(
	    	properties.getProperty("vas.db.url"),
	    	properties.getProperty("vas.db.user", "vas"),
	    	properties.getProperty("vas.db.pwd", "")
	    );
	    ...
	    bind(UserRepository.class)
	    	.toInstance(
	    		(UserRepository) DaoManager.createDao(connectionSource, User.class)
	    	);
